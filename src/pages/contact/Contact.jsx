                    ...
                    {helpContent && Object.entries(helpContent).map(([key, section]) => (
                        <div key={key} className={styles.containerAjuda}>
                            ...
                            {section.questions.map((item, index) => (
                                <div
                                    key={index}
                                    className={`${styles.pergunta} ${openQuestion === item.question ? styles.perguntaAberta : ""}`}
                                >
                                    <button
                                        className={styles.perguntaTitulo}
                                    ...
                                    {openQuestion === item.question && (
                                        <p className={styles.perguntaResposta}>{item.answer}</p>
                                    )}
                                </div>
                            ))}
                        </div>
